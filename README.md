...
The flow uses one standard, cross-platform **Clang/LLVM toolchain** for the RV64
bare-metal programs and the C++ simulator generated by Verilator. It requires
no custom compiler, patched MLIR/LLVM toolchain, or project-pinned MLIR/LLVM
version. Performance comes primarily from explicitly written kernels, data
movement, and accelerator scheduling rather than compiler-specific tricks.
