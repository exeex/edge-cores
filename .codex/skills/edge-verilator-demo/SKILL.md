...
switch the public flow back to files under private `src/edge-e3` or
`src/edge-asic`.
...
or `src/edge-asic`; keep failures about missing encrypted RTL, SoC files, or
SRAM models explicit.
